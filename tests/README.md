...
Tests run against these pages on staging (`https://stg2.treasury.gov`):
...
|----------|-------------|---------|
| `BASE_URL` | Target site URL | `https://stg2.treasury.gov` |

**Alternative URLs:**
- CloudFront direct: `https://d216skv4tzbpyp.cloudfront.net`
