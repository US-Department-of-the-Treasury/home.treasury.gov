---
title: Testimony of Under Secretary Cohen before the Senate Foreign Relations Committee on Iran
date: 2015-01-21T07:00:00-05:00
draft: false
press_release_number: JL9746
url: /news/press-releases/jl9746
---
*(Archived Content)*

 

**As prepared for delivery WASHINGTON** - Good morning.  Chairman Corker, Ranking Member Menendez, and distinguished members of the committee:  Thank you for the invitation to appear before you to discuss the state of sanctions on Iran, and whether our efforts to achieve a diplomatic solution to one of the most difficult and enduring national security problems that we face – Iran’s nuclear program – would be advanced if Congress were to enact new sanctions legislation at this time.
...
When I last appeared before this Committee in July, I suggested three metrics by which to judge Iran’s economic distress – its oil revenues, the value of its currency, and its foreign reserves.  By all three measures, Iran continues to be worse off today than it was when it entered into the JPOA.
