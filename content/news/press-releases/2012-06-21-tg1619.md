---
title: Treasury, Switzerland Agree to Pursue Framework for Cooperation for Implementing FATCA
date: 2012-06-21T08:00:00-04:00
draft: false
url: /news/press-releases/tg1619
---
*(Archived Content)*

**New Agreement to Strengthen Cooperation in Combating Tax Evasion, Reduce Administrative Burden on Financial Institutions WASHINGTON –**The U.S. Department of the Treasury today jointly issued a[statement with Switzerland](https://home.treasury.gov/system/files/136/archive-documents/FATCA-Joint-Statement-US-Switzerland.pdf)expressing mutual intent to pursue a framework for intergovernmental cooperation to facilitate the implementation of the Foreign Account Tax Compliance Act (FATCA) and improve international tax compliance based on the bilateral tax treaty between the United States and Switzerland.
...
Treasury and the IRS will continue to work closely with businesses and foreign governments to implement FATCA effectively.  Updates and further information on FATCA can be found by visiting the FATCA page on[www.IRS.gov](http://www.IRS.gov).
