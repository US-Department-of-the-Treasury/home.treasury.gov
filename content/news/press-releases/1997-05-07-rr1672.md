...
As recently pointed out by mycolleague and friend, Andrew Sheng, the Deputy Chief Executive of the Hong Kong Monetary Authority, Hong Kong is perhaps theworld’s leading example of the economy of the future -- avirtual economy -- where services account for about 82% of GDP,as compared to 76% here and 62% in Japan, and the bulk of themanufacturing activity of its firms is done outside itsterritorial boundaries. It is thus by its very nature, perhapsmore so than any other economy in the world, highly dependent onthe free flow of information (over 700 newspapers and periodicalsare based there), the rule of law and the transparency of theregulatory environment.
