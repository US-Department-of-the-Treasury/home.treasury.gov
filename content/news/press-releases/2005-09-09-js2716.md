...
**IV. Other Matters and Venue of the Next Meeting**Considering the importance of private sector input, we welcomed the active informal dialogue with the APEC Business Advisory Council (ABAC). Also we appreciate the contribution of the Pacific Economic Cooperation Council (PECC) Finance Forum on ways to promote APEC economies' cooperation and enhance the financial system. They provided both valuable insights from the private and academic perspective and support for the work under the themes of the 12th APEC Finance Ministers' Process.
