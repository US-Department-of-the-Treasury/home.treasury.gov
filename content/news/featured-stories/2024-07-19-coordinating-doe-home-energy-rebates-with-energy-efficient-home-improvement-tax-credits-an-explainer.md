...
The IRA allocates $8.8 billion to the U.S. Department of Energy’s (DOE)[Home Energy Rebate programs](https://www.energy.gov/scep/office-state-and-community-energy-programs). The Home Efficiency Rebates (HOMES) program assists homeowners and renters with whole-house energy-saving retrofits. The Home Electrification and Appliances Rebates (HEAR) program helps homeowners and renters implement energy-efficiency measures, including transitions to electric appliances.[1](#_ftn1)

In addition to the rebate programs, the IRA expanded and extended the[Energy Efficient Home Improvement Tax Credit](https://www.irs.gov/pub/irs-pdf/p5967.pdf), also called the 25C tax credit, including by increasing the maximum credit amount and eliminating the lifetime limit.[2](#_ftn2)
...
- When DOE Home Energy Rebates are applied to a project or product, they are treated as reductions in the purchase price rather than as income for tax purposes. Therefore, households that receive DOE Home Energy Rebates should not report the rebates as income on their income tax returns.[3](#_ftn3)
...
The law does not limit HOMES rebate eligibility based on household income, but households that are at or below 80 percent of their area median income (AMI) are eligible for larger rebates.[4](#_ftn4)The HOMES program is available for rented, single-family, or multifamily homes, but not for new-construction homes.

HEAR program eligibility is limited to households below 150 percent of AMI. Households at or below 80 percent of AMI are eligible for larger rebates.[5](#_ftn5)The law applies to rented, single-family, or multifamily homes.

### Examples of households using DOE Home Energy Rebates and 25C tax credits

Many state and local governments and utilities have their own benefit programs that can be combined with 25C tax credits.[6](#_ftn6)

The following examples illustrate how DOE Home Energy Rebates and the 25C tax credits can be used to reduce the cost of energy-saving home upgrades.[7](#_ftn7)

### Example 1: HOMES rebates with all retrofit measures eligible for 25C tax credits

If a taxpayer purchases item(s) eligible for both a HOMES rebate and 25C tax credit, the taxpayer may make a pro rata allocation of amounts received as rebates to individually itemized expenditures as a share of total project cost in determining the amounts paid or incurred for such items under § 25C.[8](#_ftn8)

For example, Anthony Evans receives a $2,000 rebate for a whole-house energy-saving retrofit that costs $5,000 in 2024.  The retrofit consists of a $3,000 heat pump and $2,000 of insulation that he installs in 2024.[9](#_ftn9)

- The rebate is proportionately allocated so 60 percent[10](#_ftn10)is applied to $3,000 in qualifying expenditures for a heat pump ($1,200 of the $2,000 rebate) and 40 percent[11](#_ftn11)is applied to $2,000 in qualifying expenditures for insulation ($800 of the $2,000 rebate).
...
- They then[insulate](https://www.energystar.gov/saveathome/seal_insulate)their attic for $2,500.
- They purchase an eligible[heat pump](https://www.energystar.gov/products/ductless_heating_cooling)for $3,000 and install a[smart thermostat](https://www.energystar.gov/products/smart_thermostats)for $200.
...
Since the Winthrops receive the rebate as an* upfront discount*, the* real*upfront cost of the technology for the retrofit is $4,150.[12](#_ftn12)Since the home energy audit, attic insulation, and heat pump are eligible for 25C tax credits of up to 30 percent of the after-rebate cost, the Winthrops can claim a $1,204.50 tax credit when filing their taxes.[13](#_ftn13)Table 3 below outlines the eligible tax credit amounts the Winthrops receive for each item.
...
In this example, the smart thermostat is part of the retrofit receiving a HOMES rebate, but it does not qualify for a 25C tax credit.[14](#_ftn14)
...
Additionally, Gomez purchased Energy Star windows, which are eligible for the HOMES rebate, but because they were not[Energy Star* Most Efficient*](https://www.energystar.gov/partner_resources/products_partner_resources/energy_star_most_efficient_2024_criteria)windows, they are not eligible for a 25C tax credit.
...
States, territories, and Tribes will need to include plans for how they will monitor requirements when projects combine multiple funding sources. The Department of Energy’s[Home Energy Rebate Administrative and Legal Requirements Document](https://www.energy.gov/scep/articles/home-energy-rebate-administrative-and-legal-requirements-document)provides additional guidance.

By coordinating the use of these credits and rebates, American families will save money on select home improvement projects that can help lower their energy bills. For more information on[Energy-Efficient Home Improvement Tax Credit check out this explainer](https://www.irs.gov/pub/irs-pdf/p5967.pdf)and then read about how[Heat Pumps Deliver Major Savings for American families](https://home.treasury.gov/news/featured-stories/heat-pumps-deliver-major-savings-for-american-families).

[[1]](#_ftnref1)Home Energy Rebates will be made available to homeowners and renters by their state, territory or Tribe as soon as summer 2024. You can learn about your state’s progress toward launching rebate programs by using[DOE's tracker](https://www.energy.gov/save/rebates).

[[2]](#_ftnref2)The expanded 25C tax credit became applicable to property placed in service on or after January 1, 2023.

[[3]](#_ftnref3)Contractors and installers** are**required to include DOE Home Energy Rebates paid directly to them in their taxable income.

[[4]](#_ftnref4)Individual states and territories, however, may limit eligibility to lower-income households.[The U.S. Department of Housing and Urban Development’s Office of Policy Development and Research](https://www.huduser.gov/portal/datasets/il.html#2021_query)provides information for understanding AMI.

[[5]](#_ftnref5)States, territories, and Tribes may limit eligibility to lower-income households, but as mandated by the Inflation Reduction Act, cannot include households making more than 150 percent of AMI.

[[6]](#_ftnref6)You can learn about your state’s benefit programs by visiting the[DOE website](https://www.energy.gov/save/rebates)and selecting your home state.

[[7]](#_ftnref7)Note that all rebates and tax credits are subject to eligibility and requirements as laid out by[DOE](https://www.energy.gov/scep/home-energy-rebates-application-guidance)and[IRS](https://www.irs.gov/credits-deductions/energy-efficient-home-improvement-credit).

[[8]](#_ftnref8)For more detail on allocation, see page 6-7 of IRS Announcement[2024-19](https://www.irs.gov/pub/irs-drop/a-24-19.pdf).

[[9]](#_ftnref9)The § 25C tax credit is available for the tax year in which the taxpayer installs the qualifying property.

[[10]](#_ftnref10)It is 60 percent because $3,000 is 60 percent of the $5,000 expended.

[[11]](#_ftnref11)Likewise, it is 40 percent because $2,000 is 40 percent of the $5,000 expended.

[[12]](#_ftnref12)Taxpayers may wish to file for an extension on their federal income tax return if the value of their rebate under the HOMES measured savings pathway is still uncertain.

[[13]](#_ftnref13)The smart thermostat is not eligible for a 25C tax credit.

[[14]](#_ftnref14)States and territories are responsible for determining the best way to monitor this requirement when projects combine multiple funding sources. Learn more by visiting the[DOE Home Energy Rebates](https://www.energy.gov/scep/home-energy-rebates-programs)webpage.
