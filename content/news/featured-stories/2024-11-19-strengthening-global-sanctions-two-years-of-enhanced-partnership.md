...
Analysis continues to be at the heart of how we design, implement, and understand the effectiveness of sanctions.  For example, how we identify areas or industries that would benefit from additional guidance or engagement or understanding significant policy changes or circumvention methodologies.  As part of our previous commitment to share analysis, we reviewed lessons learned from the successful implementation of the[new prohibitions on Russian metals jointly introduced by the United States and the United Kingdom](https://home.treasury.gov/news/press-releases/jy2249), considering the steps necessary to prevent market speculation or price increases that could be anticipated.  While operational functions have historically been at the forefront of our information-sharing, we look forward to collaborating more closely in sharing our analysis to support our future actions and any mitigation measures.
...
Lisa Palluconi, Acting Director, Office of Foreign Assets Control, U.S. Department of the Treasury
